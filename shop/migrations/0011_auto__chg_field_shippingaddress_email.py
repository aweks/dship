...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingAddress.email'
        db.alter_column('shop_shippingaddress', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))


    def backwards(self, orm):
        
        # Changing field 'ShippingAddress.email'
        db.alter_column('shop_shippingaddress', 'email', self.gf('django.db.models.fields.EmailField')(default=0, max_length=75))
