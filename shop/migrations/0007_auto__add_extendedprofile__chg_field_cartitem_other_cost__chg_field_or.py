...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_extendedprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('billing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.BillingAddress'])),
            ('commission_rate', self.gf('dropship.products.fields.CurrencyField')(null=True, max_digits=19, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('shop', ['ExtendedProfile'])

        # Changing field 'CartItem.other_cost'
        db.alter_column('shop_cartitem', 'other_cost', self.gf('dropship.products.fields.CurrencyField')(null=True, max_digits=19, decimal_places=2))

        # Changing field 'OrderItem.other_cost'
        db.alter_column('shop_orderitem', 'other_cost', self.gf('dropship.products.fields.CurrencyField')(null=True, max_digits=19, decimal_places=2))


    def backwards(self, orm):
        
        # Deleting model 'ExtendedProfile'
        db.delete_table('shop_extendedprofile')

        # Changing field 'CartItem.other_cost'
        db.alter_column('shop_cartitem', 'other_cost', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2))

        # Changing field 'OrderItem.other_cost'
        db.alter_column('shop_orderitem', 'other_cost', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2))
