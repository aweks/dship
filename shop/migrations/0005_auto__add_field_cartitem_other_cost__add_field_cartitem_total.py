...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CartItem.other_cost'
        db.add_column('shop_cartitem', 'other_cost', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'CartItem.total'
        db.add_column('shop_cartitem', 'total', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CartItem.other_cost'
        db.delete_column('shop_cartitem', 'other_cost')

        # Deleting field 'CartItem.total'
        db.delete_column('shop_cartitem', 'total')
