...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CartItem.price'
        db.add_column('shop_cartitem', 'price', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2), keep_default=False)

        # Changing field 'ShippingAddress.address_two'
        db.alter_column('shop_shippingaddress', 'address_two', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Deleting field 'BillingAddress.email'
        db.delete_column('shop_billingaddress', 'email')

        # Changing field 'BillingAddress.address_two'
        db.alter_column('shop_billingaddress', 'address_two', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))


    def backwards(self, orm):
        
        # Deleting field 'CartItem.price'
        db.delete_column('shop_cartitem', 'price')

        # Changing field 'ShippingAddress.address_two'
        db.alter_column('shop_shippingaddress', 'address_two', self.gf('django.db.models.fields.CharField')(default=0, max_length=80))

        # Adding field 'BillingAddress.email'
        db.add_column('shop_billingaddress', 'email', self.gf('django.db.models.fields.EmailField')(default=0, max_length=75), keep_default=False)

        # Changing field 'BillingAddress.address_two'
        db.alter_column('shop_billingaddress', 'address_two', self.gf('django.db.models.fields.CharField')(default=0, max_length=80))
