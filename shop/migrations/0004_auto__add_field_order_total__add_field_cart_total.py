...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_order', 'total', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Cart.total'
        db.add_column('shop_cart', 'total', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.total'
        db.delete_column('shop_order', 'total')

        # Deleting field 'Cart.total'
        db.delete_column('shop_cart', 'total')
