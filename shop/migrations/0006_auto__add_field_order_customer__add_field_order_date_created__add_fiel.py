...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_order', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']), keep_default=False)

        # Adding field 'Order.date_created'
        db.add_column('shop_order', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=0, blank=True), keep_default=False)

        # Adding field 'OrderItem.other_cost'
        db.add_column('shop_orderitem', 'other_cost', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'OrderItem.total'
        db.add_column('shop_orderitem', 'total', self.gf('dropship.products.fields.CurrencyField')(default=0, max_digits=19, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.customer'
        db.delete_column('shop_order', 'customer_id')

        # Deleting field 'Order.date_created'
        db.delete_column('shop_order', 'date_created')

        # Deleting field 'OrderItem.other_cost'
        db.delete_column('shop_orderitem', 'other_cost')

        # Deleting field 'OrderItem.total'
        db.delete_column('shop_orderitem', 'total')
    ...
    models = {
        ...
        'shop.cartitem': {
            ...
            'other_cost': ('dropship.products.fields.CurrencyField', [], {'max_digits': '19', 'decimal_places': '2'}),
