...
class RegistrationFormUserNameIsEmail(forms.Form):
    ...
    def save(self, profile_callback=None):
        """Pretty much does exactly the same as self.save() except that it calls the admin activation
           version of create_inactive_user instead.
        """
