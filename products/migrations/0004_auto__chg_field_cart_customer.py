...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cart.customer'
        db.alter_column('products_cart', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Cart.customer'
        raise RuntimeError("Cannot reverse this migration. 'Cart.customer' and its values cannot be restored.")
    ...
    models = {
        ...
        'products.cartitem': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['order.ShippingAddress']"}),
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['products.Cart']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
